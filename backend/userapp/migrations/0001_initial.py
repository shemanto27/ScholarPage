    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_experience', models.CharField(blank=True, max_length=50)),
                ('skilled_with', models.CharField(blank=True, max_length=50)),
        ...
        migrations.AddField(
            model_name='user',
            name='publications',
            field=models.ManyToManyField(related_name='users', to='userapp.publication'),
        ),
        migrations.AddField(
            model_name='user',
            name='research_interest',
            field=models.ManyToManyField(blank=True, related_name='users', to='userapp.research_interest'),
        ),
    ]
